...
func _on_plot_body_resized() -> void:
	#_draw_plot()
	_refresh_axis_labels()
	data_scatter_points.queue_redraw()
...
func _on_first_draw_timer_timeout() -> void:
	data_scatter_points.queue_redraw()
